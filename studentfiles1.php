...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="navbar-header">
      ...
      <img src="./images/logo12.jpeg" style="height: 60px; width: 150px;margin-top: 0px;">
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
     <ul class="nav navbar-nav navbar nav-pills" style="margin-left: 50px;">
      ...
      <div class="navbar-nav ml-auto" style="margin-top:13px; margin-left: 25%; ">
        <div class="dropdown">
          <button class="dropbtn">&nbsp <span class="glyphicon glyphicon-chevron-down"></span></button>
