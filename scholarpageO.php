...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
     <ul class="nav navbar-nav navbar nav-pills" style="margin-left: 50px;">         
        ...
        <li class="active"><a href="scholarpageO.php">SCHOLARSHIP</a></li>
      ...
      <div class="navbar-nav ml-auto" style="margin-top:13px; margin-left: 20%; ">
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a href="scholarpageO.php?logout='1'">Logout</a>
          </div>
        </div>
      </div>
...
<div style="">
<table class="customers" style= " margin-right: 10%; margin-bottom: 120px;margin-top: 80px; width: 600px;">
  <tr>
    <th>Scholarship</th>
    <th>Apply</th>
  </tr>
