 ...
 <br>
  <hr class="new">
 <div>
 <center><h2>Files List</h2></center>
 <?php
 ...
 if (isset($_GET['key'])) {
   ...
   $query1="SELECT * FROM `files` WHERE class_id=$id";
   ...
   while ($row=mysqli_fetch_assoc($result1)) {
     ...
     // echo "<td><a href='midmarks.php?key=".$classid."&key2=".$row1['student_email']."&key3=".$row1['student_name']."'><button type='button' class='btn btn-primary' style='width:150px;'>Enter Marks</button></a></td>";
     echo "<tr>";
     $no=$no+1;
   }
    }
