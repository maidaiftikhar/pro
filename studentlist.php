...
$query2="DELETE FROM `keytable` WHERE key_id='$rowid'";
...
if (isset($_GET['key'])) {
  ...
  while ($row=mysqli_fetch_assoc($result)) {
    ...
    echo "<td><a href='midmarks.php?key=".$classid."&key2=".$row1['student_email']."&key3=".$row1['student_name']."'>
    <button type='button' class='btn btn-primary' style='width:100px;'>Enter Marks</button></a></td>";
    echo "<td><a href='studentlist.php?cid=".$row['key_id']."'>
    <button type='button' class='btn btn-primary' style='width:130px;'>Remove Student</button></a></td>";
    echo "<tr>";
    $no=$no+1;
  }
// }
