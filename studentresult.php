...
if ($_GET['cid']) {
 ...
 <div class="">
  ...
  <br>
   <?php
   echo "<center><table border='1'  style='margin-left:0px;width:800px; border-radius:1px;background-color:lightgrey;'>";
        echo "<tr>
        <th width=120px height=40px;>Mid</th>
...
<!-- <div style="height:150px;width:170px; background-color:grey;float:right;margin-left:55%; margin-top:50px;  border-radius:5px;">
 ...
 <br>
 <br>
 <footer class="page-footer font-small indigo" style="background-color: #51b5a4; margin-top: 20%;
  <!-- Footer Links -->
